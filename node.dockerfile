...
# docker run -d --net=isolated_network --name nodeapp -p 3000:3000 -v $(pwd)/logs:/var/www/logs nicoleketch/nodeapp
# docker run -d --net=isolated_network --name nodeapp -p 3000:3000 -v $(pwd)/logs:/var/www/logs nicoleketch/nodeapp:2.0
...
# docker run -d -p 3000:3000 --link my-mongodb:mongodb --name nodeapp nicoleketch/nodeapp
